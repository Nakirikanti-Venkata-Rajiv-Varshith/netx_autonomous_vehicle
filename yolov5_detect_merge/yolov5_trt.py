...
class YoLov5TRT(object):
    ...
    def __init__(self, engine_file_path, plugin, classes, conf_thresh=0.3, iou_threshold=0.4):
        ...
        # Instead, just get the current context (created by autoinit)
...
if __name__ == "__main__":
    ...
    classes = ["person", "bicycle", "car", "motorcycle", "airplane", "bus", "train", "truck", "fire hydrant", "stop sign", "parking meter", "bench", "bird", "cat", "dog", "horse", "elephant", "bear", "zebra", "giraffe", "backpack", "umbrella", "handbag", "tie", "skis", "snowboard", "sports ball", "kite", "baseball bat", "baseball glove", "tennis racket", "bottle", "wine glass", "cup", "fork", "knife", "spoon", "bowl", "sandwich", "orange", "broccoli", "carrot", "hot dog", "pizza", "donut", "cake", "chair", "potted plant", "bed", "dining table", "toilet", "tv", "laptop", "mouse", "remote", "microwave", "oven", "toaster", "sink", "refrigerator", "book", "clock", "vase", "hair drier", "toothbrush"]
